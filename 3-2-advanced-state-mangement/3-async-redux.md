...
Back to our coffee shop. Let's consider just the step where we actually make the coffee. We're managing application-level state in Redux, but the actual process of making coffee could be handled separately by an individual component. 
